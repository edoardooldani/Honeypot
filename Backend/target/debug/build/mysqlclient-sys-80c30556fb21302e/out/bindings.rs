...
pub const MYSQL_COMPILATION_COMMENT: &[u8; 9] = b"Homebrew\0";
pub const MYSQL_COMPILATION_COMMENT_SERVER: &[u8; 9] = b"Homebrew\0";
...
fn bindgen_test_layout_MYSQL_PLUGIN_VIO_INFO() {
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).is_tls_established) as usize - ptr as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(MYSQL_PLUGIN_VIO_INFO),
            "::",
            stringify!(is_tls_established)
        )
    );
}
#[repr(u32)]
