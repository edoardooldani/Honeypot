...
impl PacketFeatures {
    ...
    pub fn to_csv_row(&self) -> String {
        ...
        format!(
            ...
            self.flow_byts_per_s,
            self.flow_pkts_per_s,
            self.flow_iat_mean,
            self.flow_iat_std,
            self.flow_iat_max,
            self.flow_iat_min,
            ...
            self.down_up_ratio,
            self.pkt_size_avg,
            self.fwd_seg_size_avg,
            self.bwd_seg_size_avg,
            self.fwd_byts_b_avg,
            self.fwd_pkts_b_avg,
            self.fwd_blk_rate_avg,
            self.bwd_byts_b_avg,
            self.bwd_pkts_b_avg,
            self.bwd_blk_rate_avg,
            self.subflow_fwd_pkts,
            self.subflow_fwd_byts,
            self.subflow_bwd_pkts,
            self.subflow_bwd_byts,
            self.init_fwd_win_byts,
